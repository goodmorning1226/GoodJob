...
export default function ExperienceEvidence({ experience, onClose, onSaved }: Props) {
  ...
  const [items,setItems] = useState<EvidenceItem[]>(() => readEvidence()[key] || []);
  ...
  return <div className="evidence-backdrop"><button className="modal-backdrop-dismiss" aria-label="關閉成果與附件" onClick={onClose} /><section className="evidence-workspace" role="dialog" aria-modal="true" aria-label="成果與附件">
